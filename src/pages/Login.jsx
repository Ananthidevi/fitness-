...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try{
      const res = await axios.get("http://localhost:8081/sets");
  ...
  return (
    ...
    <div className='flex justify-center items-center min-h-screen bg-gray-100'>
      <div className="image">
      <form onSubmit={handleLogin} className='bg-white p-6 rounded shadow w-80 mt-100 ml-210'>
        <h2 className='text-xl font-bold mb-4 text-center'>Login form</h2>
        <input placeholder='anu@mail.com' className='border p-2 w-full mb-3' type="email" value={email} onChange={(e) => setEmail(e.target.value)} />
